              ...
              >
                <div className="flex items-center gap-3 w-full">
                  <div className="relative">
                    ...
                    {conv.online && <span className="absolute bottom-0 right-0 block h-3 w-3 rounded-full bg-electric-lime ring-2 ring-card" />}
                  </div>
      ...
      <div className="w-1/2 flex flex-col bg-background/30">
        ...
        <ScrollArea className="flex-1 p-6">
          <div className="space-y-6">
            {messages.map((msg) => (
              <div key={msg.id} className={`flex items-end gap-3 ${msg.isOwn ? "justify-end" : ""}`}>
                {!msg.isOwn && (
                ...
                <div className={`max-w-md p-3 rounded-2xl ${msg.isOwn ? "bg-primary text-primary-foreground rounded-br-none" : "bg-secondary rounded-bl-none"}`}>
        ...
        <div className="p-4 border-t border-white/10">
          <div className="relative">
            <Input placeholder="Escribe un mensaje..." className="pr-28" />
      ...
      <div className="w-1/4 border-l border-white/10 flex flex-col">
         <ScrollArea className="flex-1">
            <div className="flex flex-col items-center text-center p-6">
                ...
                <p className="text-sm text-muted-foreground">@gaia.sol</p>
                <Badge variant="outline" className="mt-2 border-electric-lime text-electric-lime">Online</Badge>
            </div>
            <Separator className="bg-white/10" />
            <div className="p-6 space-y-4 text-sm">
                <p className="text-muted-foreground">Bióloga de sistemas y arquitecta de entornos virtuales. Co-creadora del bioma 'Bosque Primordial'.</p>
